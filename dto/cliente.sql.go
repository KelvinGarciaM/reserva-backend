...
func (q *Queries) DeleteCliente(ctx context.Context, cedula int32) (sql.Result, error) {
...
func (q *Queries) GetClienteByCedula(ctx context.Context, cedula int32) (Cliente, error) {
...
func (q *Queries) ToggleClienteEstado(ctx context.Context, cedula int32) (sql.Result, error) {
